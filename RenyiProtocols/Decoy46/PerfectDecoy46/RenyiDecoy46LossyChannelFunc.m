function [newParams, modParser]= RenyiDecoy46LossyChannelFunc(params,options, debugInfo)
...
% later.
[transMat,detectorMat] = sixstateLinearOpticsSetup(params.transmittance,params.misalignmentAngle,params.birefringenceAngle,params.detectorEfficiency,params.probsB);
