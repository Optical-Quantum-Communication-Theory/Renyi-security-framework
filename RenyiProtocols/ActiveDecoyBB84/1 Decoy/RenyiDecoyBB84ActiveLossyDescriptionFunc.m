function [newParams,modParser] = RenyiDecoyBB84ActiveLossyDescriptionFunc(params, options, debugInfo)
arguments
    params (1,1) struct
    options (1,1) struct
...
newParams.stateTest = {diag([1,0]),vecSent/trace(vecSent)}; 
newParams.stateGen = {ones(2)/2,vecSent/trace(vecSent)};
