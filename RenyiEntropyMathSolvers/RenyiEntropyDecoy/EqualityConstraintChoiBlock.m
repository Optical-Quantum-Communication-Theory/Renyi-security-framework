classdef EqualityConstraintChoiBlock < BaseConstraint
    ...
    properties
        operatorCell (1,:) cell {mustBeNonempty,allCellsMustBeFinite(operatorCell),mustBeCellOf(operatorCell,"double"),allCellsMustBeHermitian} = {0}; % Hermitian operators inner producted with rho in the constraint.
