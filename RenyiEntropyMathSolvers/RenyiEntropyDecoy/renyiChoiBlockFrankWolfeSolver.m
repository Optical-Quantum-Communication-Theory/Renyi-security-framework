...
if options.QESMode == true
    ...
    [qesGrad,tolGrad] = QESFinderChoiBlock.getGradQES(optimalLinPoint,gradFunc(optimalLinPoint), ...
    ...
    vecQesInit = QESFinderChoiBlock.initPoint(optimalLinPoint(1:end-1),params.stateTest,params.stateGen,dimAPrime,...
